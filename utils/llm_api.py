...
def get_model_answer(model_name, inputs_list, user_dir, stream=False):
    PROJECT_ROOT_PATH = user_dir  # 用户输入的项目根目录
    # 读取LLM_CONFIG
...
class QwenLocal_API:
    def __init__(self, model_name, user_dir):
        ...
        self.CONFIG_PATH = self.USER_DIR / "config"
        # 读取LLM_CONFIG
        config_data = json.load(open(self.CONFIG_PATH / "llm_config.json", "r"))
